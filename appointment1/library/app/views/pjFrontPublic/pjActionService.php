...
<div class="asBox asServicesOuter">
	<div class="asServicesInner">
		...
		if (isset($tpl['employee_arr']) && !empty($tpl['employee_arr']))
		{
			...
			if ( isset($_SESSION[ PREFIX . $tpl['service_arr']['id'] . '_extra' ]) && count($_SESSION[ PREFIX . $tpl['service_arr']['id'] . '_extra' ]) > 0 ) {
				foreach ( $_SESSION[ PREFIX . $tpl['service_arr']['id'] . '_extra' ] as $_extra) {
