...
<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
	<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
		...
		<li class="ui-state-default ui-corner-top<?php echo $_GET['action'] == 'pjActionFreetime' ? $active : null; ?>"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminEmployees&amp;action=pjActionFreetime&amp;as_pf=<?php echo $as_pf; ?>">Free Time</a></li>
		<li class="ui-state-default ui-corner-top<?php echo $_GET['action'] == 'pjActionCustomTimes' ? $active : null; ?>"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminEmployees&amp;action=pjActionCustomTimes&amp;as_pf=<?php echo $as_pf; ?>">Custom Time</a></li>
	</ul>
</div>