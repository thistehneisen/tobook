...
if (isset($tpl['status']))
{
	...
	<legend>Style</legend>
					...
					<p><label class="title">Banner (url)</label><input type="text" name="banner" id="banner" class="pj-form-field w250" value="<?php echo isset($tpl['arr'][0]['banner']) ? $tpl['arr'][0]['banner'] : ''; ?>" /></p>
					<p><label class="title">Color</label><input type="text" name="color" id="color" class="pj-form-field w250" value="<?php echo isset($tpl['arr'][0]['color']) ? $tpl['arr'][0]['color'] : ''; ?>" /></p>
					<p><label class="title">Background</label><input type="text" name="background" id="background" class="pj-form-field w250" value="<?php echo isset($tpl['arr'][0]['background']) ? $tpl['arr'][0]['background'] : ''; ?>" /></p>
					<?php 
					$font_name = array(
						"Aclonica" => "Aclonica",
						"Allan" => "Allan",
