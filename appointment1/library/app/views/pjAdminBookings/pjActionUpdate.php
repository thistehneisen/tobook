					...
					<div class="float_right w300">
						...
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								...
								<input type="text" name="c_email" id="c_email" class="pj-form-field email w150 required" value="<?php echo pjSanitize::html($tpl['arr']['c_email']); ?>" />
							</span>
						</p>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								...
								<input type="text" name="c_phone" id="c_phone" class="pj-form-field w150 required" value="<?php echo pjSanitize::html($tpl['arr']['c_phone']); ?>" />
							</span>
						</p>
						<p>
