...
//by me
$siteBackImage       = ($_SESSION['siteDetails']['siteInfo']['backgroundimage'])?$_SESSION['siteDetails']['siteInfo']['backgroundimage']:$siteData['vimage'];
...
if (isset($_POST['btnback'])) {
    ...
    $_SESSION['siteDetails']['siteInfo']['stclr'] =  (($_POST['stclr'] =='')?'': '#'.$_POST['stclr']);

    $_SESSION['siteDetails']['siteInfo']['logoName'] = $siteLogoName;
	
	$_SESSION['siteDetails']['siteInfo']['backgroundimage'] = $siteBackImage;  // by me
    ...
    if (!validateSizePerUser($_SESSION["session_userid"], $size_per_user, $allowed_space)) {
        ...
        if($errorFlag==0){
			...
			if(is_uploaded_file($_FILES['backimage']['tmp_name'])) {
				...
				$_SESSION['siteDetails']['siteInfo']['backgroundimage'] = BASE_URL.'uploads/siteimages/'.$assignedname2;
				...
				{
					$_SESSION['siteDetails']['siteInfo']['backgroundimage'] = '';
				}
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td width="77%" align="left" valign="top">
                                                    ...
                                                    <input class="color" name="stclr" id="stclr" size="6">&nbsp;&nbsp;
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" colspan="2" valign="top">
                                                    ...
                                                    <input class="textbox" type="file" name="backimage" id="backimage" ONCLICK="checkupload2();">&nbsp;&nbsp;
