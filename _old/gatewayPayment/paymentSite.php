...
<html lang="en">
    <?php 
        ...
        $plancodeOne=$pluginGroup."_1";
        $plancodeTwo=$pluginGroup."_2"; 
        $plancodeThree=$pluginGroup."_3"; 
        ...
        $signature_one = Recurly_js::sign(array(
              
              'account'=>array(
                'account_code'=>$accountCode
              ),
              'subscription' => array(
                'plan_code' => $planCodes[$plancodeOne]
              )
        )); 
        
        $signature_two = Recurly_js::sign(array(
              
              'account'=>array(
                'account_code'=>$accountCode
              ),
              'subscription' => array(
                'plan_code' => $planCodes[$plancodeTwo]
              )
        )); 
        
        $signature_three = Recurly_js::sign(array(
              
              'account'=>array(
                'account_code'=>$accountCode
              ),
              'subscription' => array(
                'plan_code' => $planCodes[$plancodeThree]
              )
        )); 
...
?>
    ...
    <head>
        ...
        <script src="paymentSite.js"></script>
                ...
                <div class="block">
                    <fieldset id="contact_section" class="box">
                        ...
                        <div class="row-holder radio_group">
                            <form class="">
                                 <div class="radio_div"><input type="radio" class="radio_inline" onclick="selectDuration();" name="new_style4" value="<?php echo $planCodes[$plancodeOne];?>" checked> </div>
                                 <label class="inline"><?php echo $planNames[$plancodeOne]." ( 1 ~ 4 Sites )";?></label>
                                 <div class="radio_div" style="margin-top:10px;"><input type="radio" onclick="selectDuration();" class="radio_inline" name="new_style4" value="<?php echo $planCodes[$plancodeTwo];?>" > </div>
                                 <label class="inline"><?php echo $planNames[$plancodeTwo]." ( 5 ~ 7 Sites )";?></label>
                                 <div class="radio_div" style="margin-top:10px;"><input type="radio" class="radio_inline" onclick="selectDuration();" name="new_style4" value="<?php echo $planCodes[$plancodeThree];?>" /> </div>
                                 <label class="inline"><?php echo $planNames[$plancodeThree]." ( 8 ~ 10 Sites )";?></label>
                           </form>
                        </div>
                    </fieldset>
                    ...
                    <fieldset id="subscription_section" class="box">
                        ...
                        <input id="unit_amount" name="unit_amount" type="hidden" value="25.0">
                        <input id="currency" name="currency" type="hidden" value=" <?php echo CURRENCY_TYPE;?>">
                        ...
                        <div id="order_total" class="box-row box-row-hero">
                          ...
                          <span id="subscription_total" class="price">
                          </span>
                        </div>
                    </fieldset>
                </div>
...
<script type="text/javascript">
    ...
    function initalize(){
      ...
      if($(".radio_group").find("input.radio_inline").eq(0).get(0).checked){
           $("h2.name").text("<?php echo $planNames[$plancodeOne];?>") ;
           $("h2.em").text("<?php echo $price[$plancodeOne]."/".$interval[$plancodeOne];?>"+" <?php echo CURRENCY_TYPE;?>") 
           window.localStorage.setItem("signature","<?php echo $signature_one; ?>");     
           window.localStorage.setItem("plancode","<?php echo $plancodeOne; ?>");  
           $("#subscription_total").text('€'+"<?php echo $price[$plancodeOne];?>"+" <?php echo CURRENCY_TYPE;?>")
           
           $("#subscription_plan_w").find(".description").text("<?php echo $planNames[$plancodeOne];?>"+" - "+"<?php echo $interval[$plancodeOne];?>");
           $("#subscription_price").text('€'+"<?php echo $price[$plancodeOne];?>"+" <?php echo CURRENCY_TYPE;?>") ;
           window.localStorage.setItem("price","<?php echo $price[$plancodeOne]; ?>"); 
           $("#subscription_subtotal").find(".price").text("€ "+"<?php echo $price[$plancodeOne]; ?>"+" <?php echo CURRENCY_TYPE;?>");    
           $("#order_total").find(".price").text("€ "+"<?php echo $price[$plancodeOne]; ?>"+" <?php echo CURRENCY_TYPE;?>"); 
           plancode="<?php echo $plancodeOne; ?>";
      
      }
      if($(".radio_group").find("input.radio_inline").eq(1).get(0).checked){
          $("h2.name").text("<?php echo $planNames[$plancodeTwo];?>") ;
          $("h2.em").text("<?php echo $price[$plancodeTwo]."/".$interval[$plancodeTwo];?>"+" <?php echo CURRENCY_TYPE;?>" )
          window.localStorage.setItem("signature","<?php echo $signature_two; ?>");     
          window.localStorage.setItem("plancode","<?php echo $plancodeTwo; ?>");  
          $("#subscription_total").text('€'+"<?php echo $price[$plancodeTwo];?>"+" <?php echo CURRENCY_TYPE;?>")  
          
          $("#subscription_plan_w").find(".description").text("<?php echo $planNames[$plancodeTwo];?>"+" - "+"<?php echo $interval[$plancodeTwo];?>");
          $("#subscription_price").text('€'+"<?php echo $price[$plancodeTwo];?>"+" <?php echo CURRENCY_TYPE;?>") ;
          window.localStorage.setItem("price","<?php echo $price[$plancodeTwo]; ?>"); 
          $("#subscription_subtotal").find(".price").text("€ "+"<?php echo $price[$plancodeTwo]; ?>"+" <?php echo CURRENCY_TYPE;?>");    
          $("#order_total").find(".price").text("€ "+"<?php echo $price[$plancodeTwo]; ?>"+" <?php echo CURRENCY_TYPE;?>"); 
          plancode="<?php echo $plancodeTwo; ?>";
      
      }  
      if($(".radio_group").find("input.radio_inline").eq(2).get(0).checked){
          $("h2.name").text("<?php echo $planNames[$plancodeThree];?>") ;
          $("h2.em").text("<?php echo $price[$plancodeThree]."/".$interval[$plancodeThree];?>"+" <?php echo CURRENCY_TYPE;?>" )
          window.localStorage.setItem("signature","<?php echo $signature_three; ?>");     
          window.localStorage.setItem("plancode","<?php echo $plancodeThree; ?>");  
          $("#subscription_total").text('€'+"<?php echo $price[$plancodeThree];?>"+" <?php echo CURRENCY_TYPE;?>") 
          
          $("#subscription_plan_w").find(".description").text("<?php echo $planNames[$plancodeThree];?>"+" - "+"<?php echo $interval[$plancodeThree];?>");
          $("#subscription_price").text('€'+"<?php echo $price[$plancodeThree];?>"+" <?php echo CURRENCY_TYPE;?>") ;
          window.localStorage.setItem("price","<?php echo $price[$plancodeThree]; ?>"); 
          $("#subscription_subtotal").find(".price").text("€ "+"<?php echo $price[$plancodeThree]; ?>"+" <?php echo CURRENCY_TYPE;?>");    
          $("#order_total").find(".price").text("€ "+"<?php echo $price[$plancodeThree]; ?>"+" <?php echo CURRENCY_TYPE;?>"); 
          plancode="<?php echo $plancodeThree; ?>"; 
