...
<div class="page-item__edit page-item__edit__<?php echo $this->pageclass_sfx; ?>">
	...
	<div class="page_header">
		<?php echo wrap_with_tag(wrap_with_span($this->escape($params->get('page_heading'))), $template->params->get('categoryPageHeading')); ?>
	</div>
	<?php endif; ?>
		...
		<div class="btn-toolbar">
			...
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('article.cancel')">
					<i class="fa fa-times"></i> <?php echo JText::_('JCANCEL') ?>
				</button>
			</div>
		</div>
		<fieldset>
