...
<div class="login-box">
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionForgot&amp;as_pf=<?php echo $as_pf; ?>" method="post" id="frmForgotAdmin" class="form">
		...
		<p>
			...
			<a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionLogin&amp;as_pf=<?php echo $as_pf; ?>" class="no-decor l10"><?php __('lnkBack'); ?></a>
		</p>
		<?php
		if (isset($_GET['err']))
		{
