   ...
   function getsubcategory()
   {
	   ...
	   $this->datatables
		...
		$this->datatables->add_column("Actions", 
			"<center>			<a href='index.php?module=categories&amp;prefix=" . PREFIX . "&amp;view=edit_subcategory&amp;id=$1' class='tip' title='".$this->lang->line("edit_subcategory")."'><i class=\"icon-edit\"></i></a>
							    <a href='index.php?module=categories&amp;prefix=" . PREFIX . "&amp;view=delete_subcategory&amp;id=$1' onClick=\"return confirm('". $this->lang->line('alert_x_subcategory') ."')\" class='tip' title='".$this->lang->line("delete_subcategory")."'><i class=\"icon-remove\"></i></a></center>", "id")
			->unset_column('id');
