                    ...
                    <tr>
                        ...
                        <td width="77%" align="right">
                            ...
                            <div align="center" id="items_top_area">
                                &nbsp;&nbsp;
                                <a title="OnlineInstallationManual" href="#" onClick="window.open('<?php echo BASE_URL; ?>docs/easycreate.pdf','OnlineInstallationManual','top=100,left=100,width=820,height=550,scrollbars=yes,toolbar=no,status=yrd');"><strong>Installation manual</strong></a> |
                                <a title="Readme" href="#" onClick="window.open('<?php echo BASE_URL; ?>docs/Readme.txt','Readme','top=100,left=100,width=820,height=550,scrollbars=yes,toolbar=no,status=yrd');"><strong>Readme</strong></a> |
                    ...
                    <table width=85% border=0 cellpadding="2" cellspacing="2" class=maintext align="center">
                        ...
                        <tr>
                            <td align="center" class="maintext" >
                                <font color="#F4700E" size="+1">Congratulations! The Installation Process Completed Successfully!</font>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <fieldset>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="95%" class="maintext" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td ><a style="cursor:pointer;text-decoration: none;" href="<?php echo BASE_URL; ?>"><img src="css/home_page.jpg" border="0" height="25" align="absmiddle">&nbsp; &nbsp;<?php echo BASE_URL.'index.php'; ?></a></td>
                                        </tr>
                                    </table>
                                </fieldset>	
                            </td>
