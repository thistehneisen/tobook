                    ...
                    <div class="color-picker01 right">
                        ...
                        if (mysql_num_rows($res_template_theme) > 0) {
                            ...
                            while ($row_template_theme = mysql_fetch_array($res_template_theme)) {
                                ...
                                ?>
                                <!--<a href="javascript:void(0);" onclick="<?php if ($redirect_type == 'redirect') { ?>changehiddenvalue(<?php echo $templateid; ?>,<?php echo $row_template_theme['theme_id'] ?>)<?php } ?>;changehomeimage(<?php echo $templateid; ?>,'home','<?php echo $row_template_theme['theme_image_home'] ?>'); changesubimage(<?php echo $templateid; ?>,'sub','<?php echo $row_template_theme['theme_image_sub'] ?>');">-->
                        <a href="javascript:void(0);" onclick="changehiddenvalue(<?php echo $templateid; ?>,<?php echo $row_template_theme['theme_id'] ?>);changehomeimage(<?php echo $templateid; ?>,'home','<?php echo $row_template_theme['theme_image_home'] ?>'); changesubimage(<?php echo $templateid; ?>,'sub','<?php echo $row_template_theme['theme_image_sub'] ?>');">
                                    <ul>
...
<div id="jqtemplateloading" style="display:none;"><img src="images/loading.gif"></div>
                    </div>
                    <div class="clear"></div>
                </div>
            </td>
                ...
                //if ($redirect_type == 'redirect') {
                    if ($_SESSION['session_userid'] > 0) {
                        ...
                        <form name="frmChooseTemplate" method="post" action="getsitedetails.php">
                            ...
                            <input type="submit" class="btn04" value="Continue">
                        </form>
                        <?php
                    //}
                    ?> 
