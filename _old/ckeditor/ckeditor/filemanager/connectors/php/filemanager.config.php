...
//  $temp=mail("rajath.k@armiasystems.com","test",$_SESSION['imagesavepath']."....".$config['doc_root']);
 $config['doc_root'] = $_SESSION['imagesavepath'];//'C:/xampp/htdocs/ckeditor/ckeditor/uploads/';
