...
if($_GET["delact"]=="delete"){
	...
	// get the username
	$sql = "select vuser_login from tbl_user_mast where nuser_id='".$_GET["delid"]."'";
	$result = mysql_query($sql,$con);
	if( $row = mysql_fetch_array($result) ){
		$prefix = $row['vuser_login'];
		
		mysql_query("drop table ".$prefix."_restaurant_booking_bookings", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_bookings_menu", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_bookings_tables", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_bookings_tables_group", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_countries", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_dates", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_menu", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_options", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_roles", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_service", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_tables", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_tables_group", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_template", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_users", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_vouchers", $con);
		mysql_query("drop table ".$prefix."_restaurant_booking_working_times", $con);
		
		mysql_query("drop table ".$prefix."_sma_billers", $con);
		mysql_query("drop table ".$prefix."_sma_calendar", $con);
		mysql_query("drop table ".$prefix."_sma_categories", $con);
		mysql_query("drop table ".$prefix."_sma_comment", $con);
		mysql_query("drop table ".$prefix."_sma_customers", $con);
		mysql_query("drop table ".$prefix."_sma_damage_products", $con);
		mysql_query("drop table ".$prefix."_sma_date_format", $con);
		mysql_query("drop table ".$prefix."_sma_deliveries", $con);
		mysql_query("drop table ".$prefix."_sma_discounts", $con);
		mysql_query("drop table ".$prefix."_sma_groups", $con);
		mysql_query("drop table ".$prefix."_sma_invoice_types", $con);
		mysql_query("drop table ".$prefix."_sma_login_attempts", $con);
		mysql_query("drop table ".$prefix."_sma_pos_settings", $con);
		mysql_query("drop table ".$prefix."_sma_products", $con);
		mysql_query("drop table ".$prefix."_sma_purchase_items", $con);
		mysql_query("drop table ".$prefix."_sma_purchases", $con);
		mysql_query("drop table ".$prefix."_sma_quote_items", $con);
		mysql_query("drop table ".$prefix."_sma_quotes", $con);
		mysql_query("drop table ".$prefix."_sma_sale_items", $con);
		mysql_query("drop table ".$prefix."_sma_sales", $con);
		mysql_query("drop table ".$prefix."_sma_settings", $con);
		mysql_query("drop table ".$prefix."_sma_subcategories", $con);
		mysql_query("drop table ".$prefix."_sma_suppliers", $con);
		mysql_query("drop table ".$prefix."_sma_suspended_bills", $con);
		mysql_query("drop table ".$prefix."_sma_suspended_items", $con);
		mysql_query("drop table ".$prefix."_sma_tax_rates", $con);
		mysql_query("drop table ".$prefix."_sma_transfer_items", $con);
		mysql_query("drop table ".$prefix."_sma_transfers", $con);
		mysql_query("drop table ".$prefix."_sma_users", $con);
		mysql_query("drop table ".$prefix."_sma_users_groups", $con);
		mysql_query("drop table ".$prefix."_sma_warehouses", $con);
		mysql_query("drop table ".$prefix."_sma_warehouses_products", $con);
		
		mysql_query("drop table ".$prefix."_ts_booking_bookings", $con);
		mysql_query("drop table ".$prefix."_ts_booking_bookings_slots", $con);
		mysql_query("drop table ".$prefix."_ts_booking_calendars", $con);
		mysql_query("drop table ".$prefix."_ts_booking_countries", $con);
		mysql_query("drop table ".$prefix."_ts_booking_dates", $con);
		mysql_query("drop table ".$prefix."_ts_booking_options", $con);
		mysql_query("drop table ".$prefix."_ts_booking_prices", $con);
		mysql_query("drop table ".$prefix."_ts_booking_prices_days", $con);
		mysql_query("drop table ".$prefix."_ts_booking_roles", $con);
		mysql_query("drop table ".$prefix."_ts_booking_users", $con);
		mysql_query("drop table ".$prefix."_ts_booking_working_times", $con);
