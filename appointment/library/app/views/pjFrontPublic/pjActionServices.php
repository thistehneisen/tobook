...
<div class="asBox asServicesOuter">
	<div class="asServicesInner">
		...
		<?php if ( isset($tpl['category_arr']) && count($tpl['category_arr']) > 0 && isset($tpl['service_arr']) && isset($tpl['service_arr']['data']) && !empty($tpl['service_arr']['data']) ) { 
			...
			?>
				<div class="panel-group asElement asElementOutline">
		        	...
		        	<div class="accordion-body" style="display: none; <?php //echo $i==1 ? 'display: block;' : 'display: none'; ?>">
		 					...
		 					<div class="accordion">
		            			...
		            			foreach ($services as $service) {
		            				...
		            				<div class="panel-group">
		            					<div class="accordion-heading">
		            						<h4 class="accordion-title"><?php echo pjSanitize::html($service['name']); ?></h4>
		            					</div>
		            					<div class="accordion-body" style="display: none;">
							 				<div class="accordion-inner">
								 				<div class="asServiceDetails active" data-wt="0">
	            									...
	            									<div class="subDesc"><?php echo pjSanitize::html($service['description']); ?></div>
	            								</div>
		...
		<?php } ?>
			...
			<div id="dialogExtraService" title="Lisäpalvelut" style="display: none"></div>
		<?php } else {
