					...
					<div class="asElement asElementOutline">
						...
						<div class="asEmployeeAvatar">
							...
							<div class="asEmployeeDetailsRight">
								...
								<?php endif; ?>
								<div class="asElementTag asServiceTime"><?php echo isset($employee['plustime']) && (int) $employee['plustime'] > 0 ? $tpl['service_arr']['length'] + $extra['length'] + (int) $employee['plustime'] : $tpl['service_arr']['length'] + $extra['length']; ?><?php echo ("min"); ?> <?php __('front_minutes'); ?></div>
							</div>
						</div>
