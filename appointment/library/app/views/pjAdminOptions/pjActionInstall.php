...
if (isset($tpl['status']))
{
	...
	<textarea class="pj-form-field w700 textarea_install" id="install_code" style="overflow: auto; height:80px"><iframe width="100%" height="1000px" src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjAdminOptions&amp;action=pjActionPreview&amp;as_pf=<?php echo $as_pf; ?>&owner_id=<?php echo $_SESSION['owner_id'];?>"></textarea>
