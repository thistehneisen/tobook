...
if (isset($tpl['status']))
{
	...
	<div class="pjActionEmployeeWeek">
		<div style="display: inline-block; width: 100%;">
			...
			?>
				<li><a class="pj-button <?php echo $active; ?>" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionEmployeeWeek&amp;as_pf=<?php echo $as_pf; ?>&amp;employee_id=<?php echo $_GET['employee_id']; ?>&amp;date=<?php echo date('Y-m', $now) . '-' . $d; ?>"><?php echo $day; ?></a></li>
			<?php $i++;
			} ?>
			</ul>
		</div>
							...
							foreach ( $tpl['week_arr'] as $week_arr ) {
								...
								if ( $week_arr['t_arr']['admin'] == false || 
									...
									foreach ($bookings as $booking)
									{
										...
										?>
										<div class="">
											<a class="editbooking" data-employee_id="<?php echo $employee['id']; ?>" data-start_ts="<?php echo $start_ts; ?>" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBookings&amp;action=pjActionUpdate&amp;as_pf=<?php echo $as_pf; ?>&amp;id=<?php echo $booking['booking_id']; ?>"><?php echo pjSanitize::html($booking['c_name']); ?>
