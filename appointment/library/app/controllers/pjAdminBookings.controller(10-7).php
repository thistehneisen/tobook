		...
		if ($this->isAdmin())
		{
			if (isset($_POST['booking_create']))
			{
				...
				if ($id !== false && (int) $id > 0)
				{
					...
					pjBookingStatus::factory(array('booking_id' => $id, 'admin' => 1))->insert();
	...
	public function pjActionItemAdd()
	{
		...
		if ($this->isXHR() && $this->isLoged())
		{
			...
			if ( isset($_GET['employee_id']) && $_GET['employee_id'] > 0 ) {
				...
				// error_log( "SERVICE : ".var_export( $service_arr, true )."\n", 3, "/home/varausjarjestelm/logs/hey.log");
				error_log( "EMP_ID : ".$_GET['employee_id']."\n", 3, "/home/varausjarjestelm/logs/hey.log");
				error_log( "LOC_ID : ".$this->getLocaleId()."\n", 3, "/home/varausjarjestelm/logs/hey.log");
				error_log( "CAT_ID : ".$categories[0]['id']."\n", 3, "/home/varausjarjestelm/logs/hey.log");
