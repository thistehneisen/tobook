...
if (!$stop)
{
	if (isset($_SERVER['SERVER_ADDR']) && $_SERVER['SERVER_ADDR'] == '127.0.0.1')
	{
		...
		define("DEFAULT_USER",   "duongmau88_wp3");
		define("DEFAULT_PASS",   "J)86rJXLdn42@&8");
		define("DEFAULT_DB",     "duongmau88_wp3");
	...
	if (isset($_SERVER['SERVER_ADDR']) && $_SERVER['SERVER_ADDR'] == '127.0.0.1')
	{
		...
		if (!defined("INSTALL_URL")) define("INSTALL_URL", "http://www.sourcevl.com/wp-content/plugins/RestaurantBooking-1-6-14/library/");
	} else {
		if (!defined("INSTALL_FOLDER")) define("INSTALL_FOLDER", "/wp-content/plugins/RestaurantBooking-1-6-14/library/");
		if (!defined("INSTALL_PATH")) define("INSTALL_PATH", "/home/duongmau88/public_html/wp-content/plugins/RestaurantBooking-1-6-14/library/");
		if (!defined("INSTALL_URL")) define("INSTALL_URL", "http://www.sourcevl.com/wp-content/plugins/RestaurantBooking-1-6-14/library/");
