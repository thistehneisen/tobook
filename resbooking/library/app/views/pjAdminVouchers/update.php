...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminSpaces&amp;action=update&amp;id=<?php echo $tpl['arr']['id']; ?>&amp;rbpf=<?php echo PREFIX; ?>"><?php echo $RB_LANG['voucher_update']; ?></a></li>
		</ul>
	</div>

	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminVouchers&amp;action=update&amp;id=<?php echo $tpl['arr']['id']; ?>&amp;rbpf=<?php echo PREFIX; ?>" method="post" id="frmUpdateVoucher" class="form">
