...
{
//document.getElementById('textval').size=20;
//alert("PICKhello");
}
...
function my_DropFunc()
{
	...
	/*if(document.getElementById('textval')){
	   document.getElementById('textval').rows=3;
	    document.getElementById('textval').cols=3;
	    if(dd.elements.theCrop.w>31){
		 document.getElementById('textval').cols=((dd.elements.theCrop.w-31)/8)-1;
		}else{
		  document.getElementById('textval').cols=3;
		}
		
		if(dd.elements.theCrop.h>24){
		document.getElementById('textval').rows=(dd.elements.theCrop.h-24)/16;
		}else{
		  document.getElementById('textval').rows=3;
		}  
		  
		//document.getElementById('textval').maxlength=dd.elements.theCrop.w
		//alert(dd.elements.theCrop.w);
		//alert("DRPhello");
	}*/
	var colsval;
var rowsval;
if(document.getElementById('textval')){
	    ...
	    if(dd.elements.theCrop.w>31){
			...
			colsval=parseInt( (dd.elements.theCrop.w-31)/8 ) ;
			
			if(colsval>=2)
			   colsval=colsval-1;
			 if(colsval<=0)
			    colsval=1;  
			 document.getElementById('textval').cols=colsval;
		}else{
		  document.getElementById('textval').cols=3;
		}
		
		if(dd.elements.theCrop.h>24){
		rowsval=parseInt( (dd.elements.theCrop.h-24)/16 );
		if(rowsval>=2)
		   rowsval=rowsval-1;
		if(rowsval<=0)
			    rowsval=1;    
		document.getElementById('textval').rows=rowsval;
		}else{
		  document.getElementById('textval').rows=3;
		}  
