...
<div class="<?php echo $pluralVar; ?> index">
    <?php echo "<?php echo \$this->Html->link(__('New " . $singularHumanName . "', true), array('action' => 'add'),array('class'=>'button','style'=>'float: right; margin-top: -5px;')); ?>"; ?>
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            <?php
                ...
                ?>
                <th <?php echo $style; ?>><?php echo "<?php echo \$this->Paginator->sort('{$field}');?>"; ?></th>
            <?php endforeach; ?>
