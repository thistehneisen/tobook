...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', '../tmp/cache/imgs');		// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
class timthumb {
	...
	protected function calcDocRoot(){
		...
		if(strpos($_SERVER['SERVER_SOFTWARE'],'IdeaWebServer')!==false){
			$this->docRoot = ".";
