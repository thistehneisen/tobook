			...
			<table class="table" id="tblGroupList">
				<thead>
					<tr>
						...
						<th style="text-align: center;"><?php echo $MT_LANG['groupName'];?>
						</th>
						<th style="width: 160px; text-align: center;"><?php echo $MT_LANG['createdTime'];?>
						</th>
						<th style="width: 160px; text-align: center;"><?php echo $MT_LANG['updatedTime'];?>
						</th>
					</tr>
				</thead>
				<tbody>
