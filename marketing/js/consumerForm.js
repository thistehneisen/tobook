function onConsumerSave( ){
	...
	if( firstName + lastName == "" ){ alert("Please input consumer name."); return; }
	...
	$.ajax({
        ...
        dataType : "json",
        type : "POST",
        data : { ownerId : ownerId, consumerId : consumerId, firstName : firstName, lastName : lastName, email : email, phone : phone, address1 : address1, city : city },
