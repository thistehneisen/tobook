...
<body>
	...
	<div class="container">
		...
		<div class="floatright">
			<button class="btn-u btn-u-blue"
				...
				<?php echo $MT_LANG['createCampaign'];?>
			</button>
			<button class="btn-u btn-u-orange" onclick="onDeleteCampaign()">
				<i class="icon-trash"></i>&nbsp;
				<?php echo $MT_LANG['deleteCampaign'];?>
			</button>
		</div>
			...
			<table class="table" id="campaignList">
				<thead>
					<tr>
						...
						<th style="text-align: center;"><?php echo $MT_LANG['subject'];?>
						</th>
						<th style="width: 80px; text-align: center;"><?php echo $MT_LANG['status'];?>
						</th>
						<th style="width: 150px; text-align: center;"><?php echo $MT_LANG['launchTime'];?>
						</th>
						<th style="width: 150px; text-align: center;"><?php echo $MT_LANG['createdTime'];?>
						</th>
	...
	<div id="campaignDuplicatePopup" class="unshow">
		...
		<div
			...
			<?php echo $MT_LANG['createNewCampaign'];?>
		</div>
		<div style="margin: 30px 90px 30px 90px;">
			<p>
				<b><?php echo $MT_LANG['enterNewCampaignName'];?>:</b>
			</p>
			<p>
	...
	<div id="campaignStatisticsPopup" class="unshow">
		<div
			style="height: 45px; background: #3498db; color: #FFF; line-height: 45px; font-size: 20px; padding-left: 20px;">
			<?php echo $MT_LANG['campaignStatisticsInfo'];?>
		</div>
		<div style="margin: 30px 90px 30px 90px;">
