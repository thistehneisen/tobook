...
//sent back if backbutton is clicked
if($_GET["goback"]=="true"){
...
//get the post variables from form
                                   ...
                                   if($login_result=@ftp_login($conn_id, $ftp_user_name, $ftp_user_pass)){
                                                          ...
                                                          // turn passive mode on
                                                           ...
                                                           if ((!$conn_id) || (!$login_result)) {
                                                                   ...
                                                                   $buff = ftp_mdtm($conn_id, $remote_file);

                                                                   if ($buff != -1) {

                                                                                // getmodified date.
                                                                             $message.=  "<b>$vuser_file was last modified on : " . date("F d Y H:i:s.", $buff)."</b>";

                                                                        } else {

                                                                          $message.= "<b>File does not exist or No file information available</b>";
...
function goback(){
         ...
         document.deleteForm.action="ftpstatus.php?goback=true";
...
<table width=50%><tr>
<td align=center><img src=images/checkstatus.gif>
<form name="deleteForm" method=post action="ftpstatus.php?act=post&fileid=<?php echo $vuser_fileid;?>&sitename=<?php echo $vuser_site;?>&filename=<?php echo $vuser_file;?>&location=<?php echo $vuser_location;?>&remotedir=<?php echo $vremote_dir;?>">
<fieldset>
<table >

<tr>
<td align=center colspan=3 class=maintext><br><br>Please Enter Your FTP Information<br><br>&nbsp;</td>
</tr>
...
<td></td>
<td align=left><input type=textbox   class=textbox name="vuser_file" id="vuser_file"  readonly value="<?php echo $vuser_file;?>" maxlength="100"></td>
</tr>
...
<td></td>
<td align=left>
<input type=textbox name="vuser_site" id="vuser_site"   class=textbox  readonly value="<?php echo $vuser_site;?>" maxlength="100">
</td>
</tr>
...
<td></td>
<td align=left><input   class=textbox type=text name="vuser_name" id="vuser_name" maxlength="20"  value="<?php echo htmlentities($_POST["vuser_name"]); ?>"></td>
</tr>
...
<tr>
<td  colspan=3 align=center><br><input class=button type="button" onClick="validate();" value="Check Status">&nbsp;&nbsp;<input type=button   class=button value="Back"   onClick="goback();"><br>&nbsp;</td>
</tr>
