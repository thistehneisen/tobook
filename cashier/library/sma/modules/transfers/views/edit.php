        ...
        $('#code').keydown(function(e) {
            ...
            if (e.keyCode == 13) {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "<?php echo $this->config->base_url(); ?>index.php?module=transfers&view=scan_item&prefix=<?php echo PREFIX; ?>",
    ...
    echo "$('.item_name').hide();";
        ...
        $("#name").autocomplete({
            source: function(request, response) {
                $.ajax({url: "<?php echo site_url('module=transfers&view=suggestions&prefix=' . PREFIX); ?>",
            ...
            $(this).removeClass('ui-autocomplete-loading');
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "<?php echo $this->config->base_url(); ?>index.php?module=transfers&view=add_item&prefix=<?php echo PREFIX; ?>",
        ...
        $("#codes").autocomplete({
            source: function(request, response) {
                $.ajax({url: "<?php echo site_url('module=transfers&view=codeSuggestions&prefix="' . PREFIX); ?>",
...
echo form_open("module=transfers&prefix=" . PREFIX ."&view=edit&id=" . $id, $attrib); ?>
