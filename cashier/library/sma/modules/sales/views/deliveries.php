...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=sales&view=getdeliveries&prefix=<?php echo PREFIX; ?>',
...
<a href="<?php echo site_url('module=sales&prefix=' . PREFIX);?>" class="btn btn-primary"><?php echo $this->lang->line("back_to_sales"); ?></a>
