...
<script>
		...
		$('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=sales&prefix=<?php echo PREFIX; ?>&view=getwhinv&warehouse_id=<?php echo $warehouse_id; ?>',
...
<?php $links = '<li><a href="index.php?module=sales&prefix=' . PREFIX .'">'.$this->lang->line("all_warehouses").'</a></li><li class="divider"></li>';
...
<ul class="dropdown-menu">
	...
	<a href="<?php echo site_url('module=sales&view=add&prefix=' . PREFIX);?>" class="btn btn-primary">Add new sale</a>
