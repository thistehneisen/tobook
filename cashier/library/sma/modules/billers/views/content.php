...
<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=billers&view=getdatatableajax&prefix=<?php echo PREFIX; ?>',
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<p><a href="<?php echo site_url('module=billers&view=add&prefix=' . PREFIX);?>" class="btn btn-primary"><?php echo $this->lang->line("add_biller"); ?></a></p>
