...
<div class='mainInfo'>
	...
	<table id="fileData" cellpadding=0 cellspacing=10 width="100%">
		...
		foreach ($invoice_types as $row):?>
			<tr>
                ...
                <td><?php echo '<center>
                <a href="index.php?module=settings&prefix=' . PREFIX .'&view=edit_invoice_type&id=' . $row->id . '">
								...
								<a href="index.php?module=settings&prefix=' . PREFIX .'&view=delete_invoice_type&id=' . $row->id . '" onClick="return confirm(\''. $this->lang->line('alert_x_invoice_type') .'\')">
	...
	<p><a href="<?php echo site_url('module=settings&view=add_invoice_type&prefix=' . PREFIX);?>" class="button"><?php echo $this->lang->line("new_invoice_type"); ?></a></p>
