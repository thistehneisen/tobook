...
<!-- Big buttons -->
                           ...
                           <ul class="dash">
                           <li>
								<a href="index.php?module=settings&view=system_setting&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("system_setting"); ?>" class="tooltip">
                            ...
                            <li>
								<a href="index.php?module=settings&view=change_logo&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("change_logo"); ?>" class="tooltip">
									<img src="<?php echo $this->config->base_url(); ?>smlib/images/icons/upload.png" alt="" />
									<span><?php echo $this->lang->line("change_logo"); ?></span>
								</a>
							</li>
							<li>
								<a href="index.php?module=settings&view=upload_biller_logo&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("upload_biller_logo"); ?>" class="tooltip">
                            ...
                            <li>
								<a href="index.php?module=settings&view=warehouses&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("warehouses"); ?>" class="tooltip">
									<img src="<?php echo $this->config->base_url(); ?>smlib/images/icons/warehouse.png" alt="" />
									<span><?php echo $this->lang->line("warehouses"); ?></span>
								</a>
							</li><li>
								<a href="index.php?module=settings&view=add_warehouse&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_warehouse"); ?>" class="tooltip">
                            ...
                            <li>
								<a href="index.php?module=settings&view=backup_database&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("backup_database"); ?>" class="tooltip">
