...
<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=suppliers&view=getdatatableajax&prefix=<?php echo PREFIX; ?>',
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<p><a href="<?php echo site_url('module=suppliers&view=add&prefix=' . PREFIX);?>" class="btn btn-primary"><?php echo $this->lang->line("add_supplier"); ?></a></p>
