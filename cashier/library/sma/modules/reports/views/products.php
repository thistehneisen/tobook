...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=reports&prefix=<?php echo PREFIX; ?>&view=getCP<?php echo $v; ?>',
...
<p>Please customise the report below.</p>
    ...
    <?php echo form_open("module=reports&view=custom_products&prefix=" . PREFIX, "class='form-horizontal'"); ?>
