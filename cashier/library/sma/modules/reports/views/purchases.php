...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=reports&prefix=<?php echo PREFIX; ?>&view=getPurchases<?php 
...
<?php $attrib = array('class' => 'form-horizontal'); echo form_open("module=reports&view=purchases&prefix=" . PREFIX, $attrib); ?>
