...
<div class="container">
  ...
  <div class="login shadow" style="margin:15px auto; float:none; padding:0;">
    <?php $attib = array('class' => 'form-horizontal'); echo form_open('module=auth&view=reset_password&prefix=' . PREFIX . '&code=' . $code, $attib); ?>
    ...
    <div class="graybg actions">
        ...
        <a href="index.php?module=auth&view=login&amp;prefix=<?php echo PREFIX; ?>"><?php echo $this->lang->line("back_to_login"); ?></a>  </div>
        </div>
        </div>
    <?php echo form_close();?>
</div>
