...
<img src="<?php echo $this->config->base_url(); ?>assets/uploads/logos/<?php echo $biller->logo; ?>" alt="Biller Logo">
    ...
    <span class="left"><a href="<?php echo base_url(); ?>index.php?module=pos&amp;prefix=<?php echo PREFIX; ?>" style="width:80%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#000; background-color:#4FA950; border:2px solid #4FA950; padding: 10px 1px; border-radius:5px;">Back to POS</a></span>
