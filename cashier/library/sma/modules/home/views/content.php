...
<div id="tp" style="width:100%; height:300px;"></div>
                        ...
                        <ul class="dash">
                            ...
                            <li>
								<a class="tip" href="index.php?module=products&view=add&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_product"); ?>">
                            ...
                            <li>
								<a class="tip" href="index.php?module=inventories&view=add&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_purchase"); ?>">
                            ...
                            <li>
								<a class="tip" href="index.php?module=sales&view=add&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_sale"); ?>">
                            ...
                            <li>
								<a class="tip" href="index.php?module=reports&view=overview&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("reports"); ?>">
							...
							<li>
								<a class="tip" href="index.php?module=auth&view=users&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("users"); ?>">
							...
							<li>
								<a class="tip" href="index.php?module=auth&view=create_user&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_user"); ?>">
							...
							<li>
								<a class="tip" href="index.php?module=billers&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("billers"); ?>">
                            ...
                            <li>
								<a class="tip" href="index.php?module=billers&view=add&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_biller"); ?>">
                            ...
                            <li>
								<a class="tip" href="index.php?module=customers&view=add&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_customer"); ?>">
                            ...
                            <li>
								<a class="tip" href="index.php?module=suppliers&view=add&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("new_supplier"); ?>">
                        ...
                        <?php } ?>
                         ...
                         <li>
							...
							<li>
								<a class="tip" href="index.php?module=reports&view=purchases&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("reports"); ?>">
									<i><img src="<?php echo $this->config->base_url(); ?>assets/img/icons/report.png" alt="" /></i>
									<span><span><?php echo $this->lang->line("reports"); ?></span></span>
								</a>
							</li>
                        ...
                        <ul class="dash">
                           ...
                           <li style="position:relative;">
							...
							<li>
								<a class="tip" href="index.php?module=reports&view=sales&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("reports"); ?>">
									<i><img src="<?php echo $this->config->base_url(); ?>assets/img/icons/report.png" alt="" /></i>
									<span><span><?php echo $this->lang->line("reports"); ?></span></span>
								</a>
							</li>
...
<?php echo form_open("module=home&view=update_comment&prefix=" . PREFIX, 'style="margin-bottom:0;"'); ?>
