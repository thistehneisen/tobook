...
<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo site_url('module=products&prefix=' . PREFIX .'&view=getwhproducts&warehouse_id='.$warehouse_id); ?>',
...
<?php $links = '<li><a href="index.php?module=products&prefix=' . PREFIX . '">'.$this->lang->line("all_warehouses").'</a></li><li class="divider"></li>';
	foreach($warehouses as $warehouse) {
		if($warehouse->id == $warehouse_id) {
			$wh_name = $warehouse->name;
			echo $wh_name;
		} else {
			$links .= "<li><a href='index.php?module=products&prefix=" . PREFIX . "&view=warehouse&warehouse_id=".$warehouse->id."'>".$warehouse->name."</a></li>";
		}
	} 
	?>
...
<ul class="dropdown-menu">
	...
	<a href="<?php echo site_url('module=products&view=add&prefix=' . PREFIX);?>" class="btn btn-primary pull-left"><?php echo $this->lang->line("add_product"); ?></a>
