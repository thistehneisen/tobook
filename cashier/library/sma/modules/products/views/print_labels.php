...
$(document).ready(function(){
    $('#category').change(function(){
      // window.location.href = "<?php echo base_url(); ?>index.php?module=products&amp;prefix=<?php echo PREFIX; ?>&view=sheet&category_id="+$(this).val();
       window.location.replace("<?php echo base_url(); ?>index.php?module=products&prefix=<?php echo PREFIX; ?>&view=labels&category_id="+$(this).val());
       return false;
   }); 
});
</script>
...
<body>
     <div class="container">
		<h4><?php echo SITE_NAME.' - '.$page_title; ?> <a class="btn btn-primary" href="<?php echo base_url(); ?>index.php?module=home&amp;prefix=<?php echo PREFIX; ?>"><i class="icon-home icon-white"></i> <?php echo $this->lang->line('home'); ?></a></h4>
