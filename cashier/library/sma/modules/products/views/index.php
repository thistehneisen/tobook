...
<script>
			...
			?>
                    'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=products&view=getdatatableajaxcost&prefix=<?php echo PREFIX; ?>',
                        <?php } else { ?>
                    'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=products&view=getdatatableajax&prefix=<?php echo PREFIX; ?>',
                        <?php } ?>
...
<ul class="dropdown-menu">
	...
	foreach($warehouses as $warehouse) {
		echo "<li><a href='index.php?module=products&prefix=" . PREFIX ."&view=warehouse&warehouse_id=".$warehouse->id."'>".$warehouse->name."</a></li>";	
	}
	?>
    </ul>
    </div>
