...
<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=customers&prefix=<?php echo PREFIX; ?>&view=getdatatableajax',
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<p><a href="<?php echo site_url('module=customers&prefix=' . PREFIX . '&view=add');?>" class="btn btn-primary"><?php echo $this->lang->line("add_customer"); ?></a></p>
