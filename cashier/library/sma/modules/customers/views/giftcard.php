...
<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=customers&prefix=<?php echo PREFIX; ?>&view=getgiftcardajax',
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<table id="fileData" cellpadding=0 cellspacing=10 class="table table-bordered table-hover table-striped">
        ...
        <tr>
			...
			<th><?php echo $this->lang->line("giftcard_code"); ?></th>
            <th><?php echo $this->lang->line("giftcard_value"); ?></th>
            <th><?php echo $this->lang->line("giftcard_date"); ?></th>
		</tr>
        </thead>
		<tbody>
			<tr>
