...
//index or inventories page
    ...
    function getquotes() {
        ...
        $this->datatables
                ...
                ->from('quotes')
                ->add_column("Actions", "<center><a href='#' title='$2' class='tip' data-html='true'><i class='icon-folder-close'></i></a> <a href='#' onClick=\"MyWindow=window.open('index.php?module=quotes&amp;prefix=" . PREFIX . "&view=view_quote&id=$1', 'MyWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=1000,height=600'); return false;\" title='" . $this->lang->line("view_quote") . "' class='tip'><i class='icon-fullscreen'></i></a> 
								<a href='index.php?module=sales&amp;prefix=" . PREFIX . "&view=quote_to_invoice&quote_id=$1' title='" . $this->lang->line("convert_to_invoice") . "' class='tip'><i class='icon-random'></i></a> 
								<a href='index.php?module=quotes&amp;prefix=" . PREFIX . "&view=pdf&id=$1' title='" . $this->lang->line("download_pdf") . "' class='tip'><i class='icon-file'></i></a> 
								
								<a href='index.php?module=quotes&amp;prefix=" . PREFIX . "&view=email_quote&id=$1' title='" . $this->lang->line("email_quote") . "' class='tip'><i class='icon-envelope'></i></a>
								<a href='index.php?module=quotes&amp;prefix=" . PREFIX . "&amp;view=edit&amp;id=$1' title='" . $this->lang->line("edit_quote") . "' class='tip'><i class='icon-edit'></i></a>
							    <a href='index.php?module=quotes&amp;prefix=" . PREFIX . "&amp;view=delete&amp;id=$1' onClick=\"return confirm('" . $this->lang->line('alert_x_quote') . "')\" title='" . $this->lang->line("delete_quote") . "' class='tip'><i class='icon-trash'></i></a></center>", "id, internal_note")
                ->unset_column('id')
