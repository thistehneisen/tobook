	...
	$("#dyTable").on("click", '.del', function() {
		...
		close: function () {
			$('#name').val('');
                ...
                $("#codes").autocomplete({
                            source: function(request, response) {
                                $.ajax({url: "<?php echo site_url('module=quotes&view=codeSuggestions&prefix=' . PREFIX); ?>",
...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<?php $attrib = array('class' => 'form-horizontal', 'id' => 'addSale_form'); echo form_open("module=quotes&prefix=" . PREFIX . "&view=edit&id=".$id, $attrib); ?>
