...
class CashierManager {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'cashier_manager';
	...
	public static function activate( $network_wide ) {
		...
		$rb_db_version = get_option('cm_db_version');
		...
		setcookie("cashierinstall" . $table_prefix, '1', time()+3600, "/", "");
		add_option( "cm_db_version", '1' );
	}
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_menu_page(
			__( 'Cashier Manager', $this->plugin_slug ),
			__( 'Cashier Manager', $this->plugin_slug ),
			'administrator',
			$this->plugin_slug,
