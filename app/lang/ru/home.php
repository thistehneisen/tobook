...
$footerAbout = <<< HTML
<p>4. Прямой сервис бронирования и резервации услуг в салонах красоты обеспечивается АО DELFI, которое подчиняется латвийскому законодательству. Офис фирмы находится по адресу: Рига, ул. Мукусалас, 41b-8.Регистрационный номер предприятия 40003504352.</p>
