...
return [
    ...
    'time'                  => 'Время',
    'search_tagline'        => 'Какую услугу Вы желайте заказать?',
    ...
    'current_total_bookings'=> 'Количество забронированных услуг',
    'search'        => [
        'tagline'                => 'Какую услугу Вы желайте заказать?',
        ...
        'please_try'             => 'Пожалуйста ИСПОЛЬЗУЙТЕ одно из этих ключевых слов',
        'validation'      => [
    ...
    'choose_category'     => 'Какую услугу Вы желайте заказать?',
    'how_does_it_work'    => 'Как это работает?',
    'businesses'          => 'Какую услугу Вы желайте заказать?',
