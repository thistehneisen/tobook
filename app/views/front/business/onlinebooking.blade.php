...
<div class="loyalty-general-info">
    <div class="loyalty-general-info-column">
        <div class="loyalty-general-info-row">
            <img src="{{ asset_path('core/img/iconArrow.png') }}" />&nbsp;
...
<div class="kantis-info-content"><img src="{{ asset_path('core/img/appPCs.png') }}"/></div>
...
<div class="timeslot-demo">
    <div class="timeslot-demo-image"><img src="{{ asset_path('core/img/appThumb01.png') }}"></div>
...
<div class="timeslot-demo">
    ...
    <div class="timeslot-demo-image margin"><img src="{{ asset_path('core/img/appThumb02.png') }}"></div>
    <div class="clear-both"></div>
</div>

<div class="timeslot-demo">
    <div class="timeslot-demo-image"><img src="{{ asset_path('core/img/appThumb03.png') }}"></div>
    <div class="timeslot-demo-content margin">
...
<div class="timeslot-demo">
    ...
    <div class="timeslot-demo-image margin"><img src="{{ asset_path('core/img/appThumb04.png') }}"></div>
    <div class="clear-both"></div>
</div>

<div class="timeslot-demo">
    <div class="timeslot-demo-image"><img src="{{ asset_path('core/img/appThumb05.png') }}"></div>
    <div class="timeslot-demo-content margin">
...
<div class="timeslot-demo">
    <div class="timeslot-demo-image"><img src="{{ asset_path('core/img/appThumb06.png') }}"></div>
    <div class="timeslot-demo-content margin">
...
<div class="timeslot-demo">
    ...
    <div class="timeslot-demo-image margin"><img src="{{ asset_path('core/img/appThumb07.png') }}"></div>
    <div class="clear-both"></div>
</div>
