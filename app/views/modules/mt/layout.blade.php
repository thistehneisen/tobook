...
@section('content')
    <div class="btn-group-vertical col-md-3">
        ...
        <a class="btn btn-default" href="{{ URL::route('modules.mt.campaigns.index') }}">{{ trans('mt.campaign.management') }}</a>
        <a class="btn btn-default" href="#">{{ trans('mt.sms.management') }}</a>
