<ul class="nav nav-tabs" role="tablist">
    ...
    <li  @if (Route::currentRouteName() === 'as.employees.defaultTime') {{ 'class="active"' }} @endif><a href="{{ route('as.employees.defaultTime.get', array('id'=>$employee->id))}}">{{ trans('as.employees.defaultTime') }}</a></li>
