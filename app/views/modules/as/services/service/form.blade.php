...
{{ Form::open(['route' => 'as.services.create', 'class' => 'form-horizontal', 'role' => 'form']) }}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            {{ Form::select('category', $categories, isset($service) ? $service->category_id : 1, ['class' => 'form-control input-sm', 'id' => 'category']) }}
        </div>
    </div>
    <div class="form-group">
        <label for="total" class="col-sm-2 control-label">Resurssit</label>
        <div class="col-sm-5">
           {{ Form::select('resource', $resources, 1, ['class' => 'form-control input-sm', 'id' => 'resource']) }}
        </div>
    </div>
    <div class="form-group">
