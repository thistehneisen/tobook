...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        {{ Form::model($service, array('route' => array('fd.services.update', $service->id), 'method' => 'PUT', 'class' => 'form-horizontal', )) }}
        @foreach ([
        ...
        <div class="form-group">
            <div class="col-sm-offset-5 col-sm-10">
                {{ Form::submit(trans('fd.service.edit'), ['class' => 'btn btn-primary', ]) }}
            </div>
        </div>
        {{ Form::close() }}
    </div>
