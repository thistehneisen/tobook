...
<a class="js-commission-action" href="{{ route('admin.users.commissions.add', ['id' => $user->id]) }}"><i class="fa fa-plus-circle"></i></a>
<a class="js-commission-action" href="{{ route('admin.users.commissions.subtract', ['id' => $user->id]) }}"><i class="fa fa-minus-circle"></i></a>
