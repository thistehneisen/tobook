...
?>
    ...
    <head>
        ...
        <script src="paymentOne.js"></script>
            ...
            <div id="content">
                ...
                <div class="block-header">
                    <div class="left description">
                      <h2 class="primary name">Buy Credit Card</h2>
                    </div>
                ...
                <div class="block">
                    ...
                    <fieldset id="credit_card_section" class="box">
                         <h3>Pay Amount</h3>
                         <input id="amount" maxlength="50" style="" name="billing_info[address1]" placeholder="Pay Amount"  size="50" type="text">
                    </fieldset>
