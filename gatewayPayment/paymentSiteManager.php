...
?>
    ...
    <head>
        ...
        <script src="paymentSiteManager.js"></script>
            ...
            <div id="content">
                ...
                <div class="block-header">
                    <div class="left description">
                      <h2 class="primary name">Site Manager</h2>
                    </div>
                    <div class="right price">
                        <h2 class="em">
                             <?php echo $price[$planCode].CURRENCY_TYPE;?>
                        </h2>
                ...
                <div class="block">
                    ...
                    <fieldset id="credit_card_section" class="box" style="display:none;">
                         <h3>Pay Amount</h3>
                         <input id="amount" maxlength="50" style="" name="billing_info[address1]" placeholder="Pay Amount"  size="50" type="text" value="<?php echo $price[$planCode];?>">
                    </fieldset>
                 ...
                 <div class="subscribe-block">
                        ...
                        <button type="submit" class="pay large close" id="pay-creditcard" onclick="parent.onClosePayment();">
                          Close
                        </button>
                        <button type="submit" class="pay large" id="pay-creditcard" onclick="pay();">
                          Buy
                        </button>
