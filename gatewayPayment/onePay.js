...
function pay() {
    ...
    if (!($.isNumeric(amount))) {
        alert("You have to enter amount correctly");
        return;
    }
    if (!validateEmail(email)) {
        alert("You have to enter the email correctly");
        return;
    }
    ...
    $.ajax({
        ...
        success : function(data) {
            if (data.result == "success") {
                ...
                $.ajax({
                    dataType : 'jsonp',
                    url : 'https://klikkaajaa.recurly.com/jsonp/klikkaajaa/transactions/create',
                    data : {
                        signature : signature,
                        billing_info : {
                            first_name : first_name,
