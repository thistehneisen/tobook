...
<div class="row-fluid">
<div class="span6">
<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=settings&view=change_logo&prefix=" . PREFIX, $attrib); ?>
...
<div class="span6">
<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=settings&view=change_login_logo&prefix=" . PREFIX, $attrib); ?>
<div class="control-group">
