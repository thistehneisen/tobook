	...
	<div id="wrapper">
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner" style="padding-left: 10px;">
				...
				<div class="brand"><img src="<?php echo $this->config->base_url(); ?>assets/img/<?php echo LOGO; ?>" alt="<?php echo SITE_NAME; ?>" /></div>
...
<?php } ?>
										...
										<td
											...
											colspan="2"><span id="ds">0.00</span></td>
									</tr>
									<tr>
										<td
							...
							<div id="botbuttons" style="text-align: center;">
								...
								<button type="button" class="cyan bot" id="print"
									onClick="window.print(); return false;"><?php echo $this->lang->line('print'); ?></button>
