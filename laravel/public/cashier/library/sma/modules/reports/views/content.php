...
<!-- Big buttons -->
                           ...
                           <ul class="dash">
                            <li>
								<a href="index.php?module=reports&view=products&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("product_reports"); ?>" class="tooltip">
							...
							<li>
								<a href="index.php?module=reports&view=purchases&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("purchase_reports"); ?>" class="tooltip">
                            ...
                            <li>
								<a href="index.php?module=reports&view=sales&amp;prefix=<?php echo PREFIX; ?>" title="<?php echo $this->lang->line("sale_reports"); ?>" class="tooltip">
