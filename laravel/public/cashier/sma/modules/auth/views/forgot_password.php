...
<div class="container">
  ...
  <div class="login shadow" style="margin:15px auto; float:none; padding:0;">
    <?php $attib = array('class' => 'form-horizontal'); echo form_open("module=auth&view=forgot_password&prefix=" . PREFIX, $attib); ?>
    ...
    <div class="actions graybg"> <?php echo form_submit('submit', $this->lang->line("submit"), 'class="btn btn-primary" style="padding: 6px 15px;"');?> <a href="index.php?module=auth&view=login&amp;prefix=<?php echo PREFIX; ?>" style="margin-left:15px;"><?php echo $this->lang->line("back_to_login"); ?></a> </div>
