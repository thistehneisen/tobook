...
*/
   ...
   function getdatatableajax()
   {
	   ...
	   $this->datatables
			...
			->add_column("Actions", 
			"<center><a href='index.php?module=suppliers&amp;prefix=" . PREFIX . "&amp;view=edit&amp;id=$1' title='".$this->lang->line("edit_supplier")."' class='tip'><i class='icon-edit'></i></a> <a href='index.php?module=suppliers&amp;view=delete&amp;id=$1' onClick=\"return confirm('". $this->lang->line('alert_x_supplier') ."')\" title='".$this->lang->line("delete_supplier")."' class='tip'><i class='icon-trash'></i></a></center>", "id")
			->unset_column('id');
