<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=transfers&view=gettransfers&prefix=<?php echo PREFIX; ?>',
...
<h3 class="title"><?php echo $page_title; ?></h3>
	...
	<p><a href="<?php echo site_url('module=transfers&view=add&prefix=' . PREFIX);?>" class="btn btn-primary"><?php echo $this->lang->line("add_transfer"); ?></a></p>
