<script>
             $(document).ready(function() {
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=categories&prefix=<?php echo PREFIX; ?>&view=getsubcategory<?php if($parent_id) { echo '&parent_id='.$parent_id; } ?>',
...
<?php if($success_message) { echo "<div class=\"alert alert-success\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $success_message . "</div>"; } ?>
	...
	<p><a href="<?php echo site_url('module=categories&prefix=' . PREFIX . '&view=add_subcategory');?>" class="btn btn-primary"><?php echo $this->lang->line("add_subcategory"); ?></a></p>
