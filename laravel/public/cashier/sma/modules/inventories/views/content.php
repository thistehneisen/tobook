...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=inventories&prefix=<?php echo PREFIX; ?>&view=getdatatableajax<?php 
...
<ul class="dropdown-menu">
	...
	foreach($warehouses as $warehouse) {
		echo "<li><a href='index.php?module=inventories&view=warehouse&prefix=" . PREFIX . "&warehouse_id=".$warehouse->id."'>".$warehouse->name."</a></li>";	
	}
	?>
    </ul>
    </div>
...
<ul class="dropdown-menu">
    <?php
	foreach($warehouses as $warehouse) {
		echo "<li><a href='index.php?module=inventories&prefix=" . PREFIX . "&view=warehouse&warehouse_id=".$warehouse->id."'>".$warehouse->name."</a></li>";	
	}
	?>
    </ul>
    </div>
