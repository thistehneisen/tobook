        ...
        $('#code').keydown(function(e) {
            ...
            if (e.keyCode == 13) {
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "<?php echo $this->config->base_url(); ?>index.php?module=inventories&view=scan_item&prefix=<?php echo PREFIX; ?>",
...
?>
        ...
        $("#name").autocomplete({
            source: function(request, response) {
                $.ajax({url: "<?php echo site_url('module=inventories&view=suggestions&prefix=' . PREFIX); ?>",
            ...
            $(this).removeClass('ui-autocomplete-loading');
                ...
                $.ajax({
                    type: "get",
                    async: false,
                    url: "<?php echo $this->config->base_url(); ?>index.php?module=inventories&view=add_item&prefix=<?php echo PREFIX; ?>",
        ...
        $("#codes").autocomplete({
            source: function(request, response) {
                $.ajax({url: "<?php echo site_url('module=inventories&view=codeSuggestions&prefix=' . PREFIX); ?>",
...
echo form_open("module=inventories&prefix=" . PREFIX . "&view=edit&id=" . $id, $attrib);
?>
