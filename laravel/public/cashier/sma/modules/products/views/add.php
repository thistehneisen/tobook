...
<?php if($message) { echo "<div class=\"alert alert-error\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>" . $message . "</div>"; } ?>
	...
	<?php $attrib = array('class' => 'form-horizontal'); echo form_open_multipart("module=products&view=add&prefix=" . PREFIX, $attrib); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        echo form_dropdown('product_type', $ps, 'products', 'id="product_type" class="tip chzn-select span4"');
        ?>
    </div>
</div>
