...
*/
	...
	function getdatatableajax()
   {
	   ...
	   $this->datatables
			...
			->from("billers")
			->add_column("Actions", 
			"<center><a href='index.php?module=billers&amp;view=edit&amp;prefix=" . PREFIX . "&amp;id=$1' class='tip' title='".$this->lang->line("edit_biller")."'><i class='icon-edit'></i></a> <a href='index.php?module=billers&amp;view=delete&amp;id=$1' onClick=\"return confirm('". $this->lang->line('alert_x_biller') ."')\" title='".$this->lang->line("delete_biller")."' class='tip'><i class='icon-trash'></i></a></center>", "id")
			->unset_column('id');
