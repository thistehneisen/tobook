                    ...
                    <td >
                        ...
                        <form name=frmSiteDetails method=post  enctype="multipart/form-data" onsubmit="return validateform();">
                            ...
                            <table width="100%"  border="0" class="customize-tbl" cellpadding="0" cellspacing="0">
                                ...
                                <?php
                                if ($siteColor != "") {
                                    //echo "<script>document.getElementById('sitecolor').style.backgroundColor='#" . $siteColor . "';</script>";
                                        ...
                                        <table width="100%" border="0" CELLSPACING="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2" align="right">
                                                    ...
                                                    <input class="btn04" type="submit"t name=btncontinue value="<?php echo TEMPLATE_CONTINUE;?>">
