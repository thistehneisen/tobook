                ...
                <tr>
                  ...
                  <tr>
                    <td>
                        ...
                        ".LOGIN_CLICK." <a href='".BASE_URL."/login.php'>here</a>".TO_LOGIN.
...
<div class="headingstyle_new">
	...
	<h5><?php echo SIGNUP_CAPTION; ?></h5>
</div>

<div class="common_box" align="center">
    
    <form name="regForm" method=post action=signup.php?act=post>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="commntbl_style1" align="left">
            ...
            <tr>
                ...
                <td width="4%"></td>
                <td width="71%" align=left><input type=text   name="vuser_login" id="vuser_login" maxlength="15" value="<?php echo htmlentities($_POST["vuser_login"]) ?>" size="30"></td>
            </tr>
                
            <tr>
                <td align=left ><?php echo LOGIN_PASSWORD; ?><font color=red> *</font></td>
                <td></td>
                <td align=left><input  type=password name="vuser_password" id="vuser_password" maxlength="50"  value="<?php echo htmlentities($_POST["vuser_password"]) ?>" size="30"></td>
            </tr>
                
                
             <tr>
                <td align=left ><?php echo LOGIN_PASSWORD_CONFIRM; ?><font color=red> *</font></td>
                <td></td>
                <td align=left><input  type=password name="vuser_password1" id="vuser_password1" maxlength="50"  value="<?php echo htmlentities($_POST["vuser_password1"]) ?>" size="30"></td>
            </tr>
                
                
            <tr>
                <td align=left ><?php 
                 if (getFormFieldstatus($formfiledarray, 'lastName', 0)) 
                	echo SIGNUP_FIRST_NAME;
                else 
                 echo SIGNUP_NAME;
                ?><font color=red> *</font></td>
                <td></td>
                <td align=left><input type=text   name="txtFirstName" id="txtFirstName" maxlength="100"  value="<?php echo htmlentities($_POST["txtFirstName"]) ?>" size="30"></td>
            </tr>
            ...
            <?php if (getFormFieldstatus($formfiledarray, 'lastName', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_LAST_NAME;?><?php if (getFormFieldstatus($formfiledarray, 'lastName', 1)) { ?>
                        ...
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text   name="txtLastName" id="txtLastName" maxlength="100"  value="<?php echo htmlentities($_POST["txtLastName"]) ?>" size="30"></td>
                </tr>
            <?php } ?>
            <tr>
                <td align=left ><?php echo SIGNUP_EMAIL;?><font color=red> *</font></td>
                <td></td>
                <td align=left><input type=text    value="<?php echo htmlentities($_POST["vuser_email"]) ?>" name="vuser_email" id="vuser_email" maxlength="100" size="30"></td>
            </tr>
            <?php if (getFormFieldstatus($formfiledarray, 'address1', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_ADDRESS1;?><?php if (getFormFieldstatus($formfiledarray, 'address1', 1)) { ?>
                        ...
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text   name="vuser_address1"  value="<?php echo htmlentities($_POST["vuser_address1"]) ?>" id="vuser_address1" maxlength="200" size="30"></td>
                </tr>
            <?php } ?>
            ...
            /*
            if (getFormFieldstatus($formfiledarray, 'address2', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_ADDRESS2; ?><?php if (getFormFieldstatus($formfiledarray, 'address2', 1)) { ?>
                            <font color=red>*</font> 
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text    value="<?php echo htmlentities($_POST["vuser_address2"]) ?>" name="vuser_address2" id="vuser_address2" maxlength="200" size="30"></td>
                </tr>
            <?php } 
            */
            ?>
            ...
            <?php if (getFormFieldstatus($formfiledarray, 'city', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_CITY;?><?php if (getFormFieldstatus($formfiledarray, 'city', 1)) { ?>
                        ...
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text    value="<?php echo htmlentities($_POST["txtCity"]) ?>" name="txtCity" id="txtCity" maxlength="100" size="30"></td>
                </tr>
            <?php } ?>
            ...
            <?php if (getFormFieldstatus($formfiledarray, 'state', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_STATE;?><?php if (getFormFieldstatus($formfiledarray, 'state', 1)) { ?>
                        ...
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text value="<?php echo htmlentities($_POST["txtState"]) ?>" name="txtState" id="txtState" maxlength="100" size="30"></td>
                </tr>
            <?php } ?>
            ...
            <?php if (getFormFieldstatus($formfiledarray, 'zip', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_ZIP;?><?php if (getFormFieldstatus($formfiledarray, 'zip', 1)) { ?>
                        ...
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text    value="<?php echo htmlentities($_POST["txtZip"]) ?>" name="txtZip" id="txtZip" maxlength="20" size="30"></td>
                </tr>
            <?php } ?>
            ...
            <?php if (getFormFieldstatus($formfiledarray, 'phone', 0)) { ?>
                <tr>
                    ...
                    <td></td>
                    <td align=left><input type=text   name="vuser_phone"  id="vuser_phone" maxlength="30"  value="<?php echo htmlentities($_POST["vuser_phone"]) ?>" size="30"></td>
                </tr>
            <?php } ?>
                            
            <?php /*
            if (getFormFieldstatus($formfiledarray, 'fax', 0)) { ?>
                <tr>
                    <td align=left ><?php echo SIGNUP_FAX;?><?php if (getFormFieldstatus($formfiledarray, 'fax', 1)) { ?>
                            <font color=red> *</font>
                        <?php } ?></td>
                    <td></td>
                    <td align=left><input type=text   name="vuser_fax" id="vuser_fax" maxlength="30"  value="<?php echo htmlentities($_POST["vuser_fax"]) ?>" size="30"></td>
                </tr>
            <?php }
            */ ?>
            <!--commented for new design	-->
            ...
            <tr>
                ...
                <td  align="left" >
                    <p class="notetxt" style="font-size:11px; "><?php echo SIGNUP_CONDITION; ?> <?php echo(htmlentities($_SESSION["session_lookupsitename"])); ?> <a
                            href="terms.php" target=tos><?php echo SIGNUP_TERMS; ?></a></p></td>
            </tr>
                
            <tr>
                <td colspan="2">&nbsp;</td>
                <td align="left" >
					<p class="login_extralinks" style="float:left; padding:7px 85px 7px 0; "><?php echo SIGNUP_EXISTING_USER; ?> <a href="login.php"><?php echo SIGNUP_LOGIN_HERE;?> </a></p>
                    <input class="btn01" type="button" onClick="validate();" value="<?php echo strtoupper(TOP_LINKS_SIGNUP); ?>">
                    <!-- commented for new design	<input  class=button type=reset value="Reset">--></td>
            </tr>
            <tr>
