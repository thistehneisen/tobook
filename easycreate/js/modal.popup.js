...
$(document).ready(function() {
    ...
    $(".modal").click(function() {
    	...
    	var dimen 		= $(this).attr('name');
  	   	if(dimen > 0)
  	   		width = dimen;
        modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, url, loadingImage);
    });
