...
if ($_POST['selectedimage'] != "") {
    ...
    $_SESSION['backImageSelect'] = $assignedname;

    $_SESSION['siteDetails']['siteInfo']['backgroundimage'] = $assignedname;
	
	//$_SESSION['siteDetails']['siteInfo']['backgroundimage'] = BASE_URL.'uploads/siteimages/'.$assignedname;

    //copy("./uploads/siteimages/" . $filename, $urllocation . $assignedname);
    ...
    echo "<script>opener.insertBackImage('" . $urllocation . $assignedname . "','".$siteId."');window.close();</script>";

} 

$sql = "select * from tbl_site_mast where vimage!='' or vimage!='Null'";
                            ...
                            <form name="frmInsertLogo" method="post">
                                ...
                                <table width="80%" border=0>
                                    ...
                                    <td width="50%" align=center>
                                        ...
                                        <img id="<?php echo $row['vimage']; ?>" src="<?php echo $row['vimage']; ?>" onClick="selectthisimags(this.id)" width="200">
                                    ...
                                    <tr><td class=maintext>No Image found</td></tr>
