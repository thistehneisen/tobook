					...
					<p>
						...
						<span class="inline_block">
							<select name="end_ts" id="end_ts" class="pj-form-field required w110">
								...
								<?php } ?>
								<option <?php echo isset($tpl['ef_arr']['end_ts']) && $tpl['ef_arr']['end_ts'] == $tpl['t_arr']['end_ts'] ? 'selected="selected"' : null; ?> value="<?php echo $tpl['t_arr']['end_ts']; ?>"><?php echo date($tpl['option_arr']['o_time_format'], $tpl['t_arr']['end_ts']); ?></option>
							</select>
						</span>
					</p>
				</div>
