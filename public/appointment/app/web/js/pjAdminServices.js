		...
		if ($("#grid").length > 0 && datagrid) {
			...
			if (m !== null) {
				...
				var options = {
					...
					columns: [{text: myLabel.price, type: "text", sortable: true, editable: false, renderer: formatPrice, align: "right", width: 65, editableWidth: 60},
					          {text: myLabel.len, type: "spinner", min: 0, step: 1, sortable: true, editable: false, editableWidth: 50, align: "center"},
					          {text: myLabel.before, type: "spinner", min: 0, step: 1, sortable: true, editable: false, editableWidth: 50, align: "center"},
					          {text: myLabel.after, type: "spinner", min: 0, step: 1, sortable: true, editable: false, editableWidth: 50, align: "center"},
				...
				var options = {
						...
						columns: [{text: myLabel.name, type: "text", sortable: true, editable: false, width: 200},
						          {text: myLabel.show_front, type: "text", sortable: true, editable: false, width: 70},
						          {text: myLabel.message, type: "text", sortable: true, editable: false, width: 340},
						          ],
				...
				var options = {
						...
						columns: [{text: myLabel.name, type: "text", sortable: true, editable: false},
						          ...
						          {text: myLabel.length, type: "text", sortable: true, editable: false},
						          {text: myLabel.message, type: "text", sortable: true, editable: false},
						          ],
