...
$x_amount       = number_format($tpl['arr']['payment_option'] == 'deposit' ? $tpl['arr']['booking_deposit'] : $tpl['arr']['booking_total'], 2, '.', '');
$x_description  = htmlspecialchars(stripslashes($TS_LANG['front']['cart']['item_name']));
...
?>
<form method="post" action="<?php echo $url; ?>" style="display: inline" name="TSBC_FormAuthorize_<?php echo $_REQUEST['cid']; ?>">
	...
	<input type="hidden" name="x_relay_url" value="<?php echo INSTALL_URL; ?>index.php?controller=Front&amp;action=confirmAuthorize" />
	<input type="hidden" name="x_custom_calendar_id" value="<?php echo $tpl['arr']['calendar_id']; ?>" />
</form>