...
<body>
    ...
    <div class="container">
        ...
        <div class="floatright">
            <button class="btn-u btn-u-blue"
                onclick="window.location.href='campaignForm.php'">
                <i class="icon-file-text-alt"></i>&nbsp;
                <?php echo __('createCampaign');?>
            </button>
            <button class="btn-u btn-u-orange" onclick="onDeleteCampaign()">
                <i class="icon-trash"></i>&nbsp;
                <?php echo __('deleteCampaign');?>
            </button>
        </div>
                ...
                <thead>
                    <tr>
                        <th style="width: 60px; text-align: center;"
                            ...
                            id="chkAllCustomer" onclick="onCheckAllCampaign( this )" /></th>
                        <th style="width: 60px; text-align: center;"
                            data-sort-ignore="true">No</th>
                        <th style="text-align: center;"><?php echo __('subject');?>
                        </th>
                        <th style="width: 80px; text-align: center;"><?php echo __('status');?>
                        </th>
                        <th style="width: 150px; text-align: center;"><?php echo __('launchTime');?>
                        </th>
                        <th style="width: 150px; text-align: center;"><?php echo __('createdTime');?>
                        </th>
                        <th data-sort-ignore="true"
                            style="width: 200px; text-align: center;"></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            ...
                            if ($campaignList[$i]['status'] == "DRAFT") {
                                echo '<button class="btn btn-info btn-xs">'.__('draft').'</button>';
                            } elseif ($campaignList[$i]['status'] == "SCHEDULED") {
                                echo '<button class="btn btn-danger btn-xs">'.__('scheduled').'</button>';
                            } elseif ($campaignList[$i]['status'] == "SENT") {
                                echo '<button class="btn btn-success btn-xs">'.__('sent').'</button>';
                            } elseif ($campaignList[$i]['status'] == "AUTOMATION") {
                                echo '<button class="btn btn-success btn-xs">'.__('automation').'</button>';
                            }
                            ?>
                        </td>
                        <td style="text-align: center;"><?php echo $campaignList[$i]['launched_time']?>
                        </td>
                        <td style="text-align: center;"><?php echo $campaignList[$i]['created_time']?>
                        </td>
                        <td style="text-align: center;">
                            <?php 
                            if ($campaignList[$i]['status'] == "DRAFT") {
                                echo '<a class="btn-u btn-u-blue btn-xs" href="campaignForm.php?id='.base64_encode($campaignList[$i]['email_campaign']).'">'.__('edit').'</a>';
                            } elseif ($campaignList[$i]['status'] == "SCHEDULED"){
                                echo '<a class="btn-u btn-u-red btn-xs" onclick="onSendCampaignNow('.$campaignList[$i]['email_campaign'].')">'.__('sendNow').'</a>';
                            } elseif ($campaignList[$i]['status'] == "SENT"){
                                echo '<a class="btn-u btn-u-success btn-xs" onclick="onShowStatistics('.$campaignList[$i]['email_campaign'].')">'.__('statistics').'</a>';
                            }
                            ?>
                            <a class="btn-u btn-u-orange btn-xs" onclick="onShowDuplicatePopup(<?php echo $campaignList[$i]['email_campaign']?>)"><?php echo __('duplicate');?></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
    ...
    <div id="campaignDuplicatePopup" class="unshow">
        ...
        <div
            ...
            <?php echo __('createNewCampaign');?>
        </div>
        <div style="margin: 30px 90px 30px 90px;">
            <p>
                <b><?php echo __('enterNewCampaignName');?>:</b>
            </p>
            <p>
    ...
    <div id="campaignStatisticsPopup" class="unshow">
        <div
            style="height: 45px; background: #3498db; color: #FFF; line-height: 45px; font-size: 20px; padding-left: 20px;">
            <?php echo __('campaignStatisticsInfo');?>
        </div>
        <div style="margin: 30px 90px 30px 90px;">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th><?php echo __('unsubscribes');?></th>
                        <th><?php echo __('invalid');?></th>
                        <th><?php echo __('opens');?></th>
                        <th><?php echo __('clicks');?></th>
                        <th><?php echo __('bounces');?></th>
        ...
        <div style="text-align: center;">
            <button class="btn-u btn-u-orange" style="text-align: center;"
                onclick="onCloseStatisticsPopup()">
                <?php echo __('cancel');?>
            </button>
        </div>
    </div>
