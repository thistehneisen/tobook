	...
	<div class="container">
		...
		<div style="text-align: center; width: 800px; margin: 20px auto;">
			...
			<form id="imageForm" method="post" enctype="multipart/form-data"
				action='async-uploadImage.php' style="margin-bottom: 0px;">
				<input type="file" name="imageUpload" id="imageUpload"
					class="form-control" style="width: 85%; float: left;" /> <input
					type="hidden" name="uploadType" value="emailTemplate"> <input
					type="hidden" id="imagePrevDiv" value="previewImage">
				<div id="previewImage" class="previewImage floatleft">
					<?php if( $pageType == "ADD"){?>
					<img src="<?php echo DEFAULT_TEMPLATE_EMAIL;?>"
						style="width: 100%; height: 100%;" />
					<?php }else{ ?>
					<img src="<?php echo $dataTemplate['thumbnail'];?>"
						style="width: 100%; height: 100%;" />
					<?php }?>
				</div>
				<div class="clearboth"></div>
