	...
	<div class="container">
		...
		<div class="floatright">
			<button class="btn-u btn-u-blue"
				...
				<?php echo $MT_LANG['createTemplate']?>
			</button>
			<button class="btn-u btn-u-orange" onclick="onDeleteTemplate()">
				<i class="icon-trash"></i>&nbsp;
				<?php echo $MT_LANG['deleteTemplate']?>
			</button>
		</div>
			...
			<table class="table" id="templateList">
				<thead>
					<tr>
						...
						<th style="text-align: center;"><?php echo $MT_LANG['templateName']?>
						</th>
						<th style="width: 180px; text-align: center;"><?php echo $MT_LANG['createdTime']?>
						</th>
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="btn-u btn-u-blue btn-small"
							href="templateForm.php?id=<?php echo base64_encode($templateList[$i]['email_template'])?>"><?php echo $MT_LANG['edit']?>
						</a></td>
					</tr>
					<?php } ?>
				</tbody>
