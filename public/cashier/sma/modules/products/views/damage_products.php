...
<script>
             $(document).ready(function() {
                ...
                $('#fileData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=products&view=getdamageproducts&prefix=<?php echo PREFIX; ?>',
...
<h3 class="title"><?php echo $page_title; ?></h3>
	...
	<a href="<?php echo site_url('module=products&prefix=' . PREFIX);?>" class="btn btn-primary pull-left"><?php echo $this->lang->line("back_to_products"); ?></a> 
