...
<script>
             $(document).ready(function() {
                ...
                $('#slData').dataTable( {
					...
					'bProcessing'    : true,
					'bServerSide'    : true,
					'sAjaxSource'    : '<?php echo base_url(); ?>index.php?module=sales&view=getdatatableajax&prefix=<?php echo PREFIX; ?>',
...
<div class="btn-group pull-right" style="margin-left: 25px;"> <a href="#" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><?php echo $this->lang->line("all_warehouses"); ?> <span class="caret"></span> </a>
  <ul class="dropdown-menu">
	...
	foreach($warehouses as $warehouse) {
		echo "<li><a href='index.php?module=sales&prefix=" . PREFIX . "&view=warehouse&warehouse_id=".$warehouse->id."'>".$warehouse->name."</a></li>";	
	}
	?>
  </ul>
</div>
...
<a href="<?php echo site_url('module=sales&view=add&prefix=' . PREFIX);?>" class="btn btn-primary"><?php echo $this->lang->line("add_sale"); ?></a>
