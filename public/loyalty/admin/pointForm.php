			...
			<div class="panel panel-orange margin-bottom-40">
				<div class="panel-heading">
					<h3 class="panel-title">
						<i class="icon-user"></i>
						<?php echo $LC_LANG['pointManagement'];?>
					</h3>
				</div>
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" value="<?php echo $dataPoint['point_name']?>"
									class="form-control" id="pointName"
									placeholder="<?php echo $LC_LANG['pointName'];?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo $LC_LANG['required'];?>
							</label>
							<div class="col-lg-4">
								<input type="text"
									value="<?php echo $dataPoint['score_required']?>"
									class="form-control" id="scoreRequired"
									placeholder="<?php echo $LC_LANG['requiredScore'];?>">
							</div>
							<label class="col-lg-2 control-label"><?php echo $LC_LANG['discount'];?>
							</label>
							<div class="col-lg-4">
								<input type="text" value="<?php echo $dataPoint['discount']?>"
									class="form-control" id="discount"
									placeholder="<?php echo $LC_LANG['discountPercent'];?>">
							</div>
						</div>

						<div class="form-group">
							<label class="col-lg-2 control-label"><?php echo $LC_LANG['valid'];?>
							</label>
							<div class="col-lg-4">
							...
							if ($type == "Edit") {
							    ...
							    <div class="col-lg-4">
								    <input type="text" value="<?php echo $cntPoint?>"
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text"
									value="<?php echo $dataPoint['created_time']?>"
									class="form-control" readonly
									style="background: #FEFEFE; cursor: pointer;">
							</div>
							...
							<div class="col-lg-4">
								<input type="text"
									value="<?php echo $dataPoint['updated_time']?>"
									class="form-control" readonly
									style="background: #FEFEFE; cursor: pointer;">
							</div>
						</div>
						...
						<div class="form-group" style="margin-top: 40px;">
							<div class="col-lg-offset-1 col-lg-10" style="text-align: center;">
								...
								<button class="btn-u btn-u-red" style="width: 120px;"
									onclick="window.location.href='pointList.php'">
									<i class="icon-list"></i>
