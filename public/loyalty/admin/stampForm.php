			...
			<div class="panel panel-orange margin-bottom-40">
				<div class="panel-heading">
					<h3 class="panel-title">
						<i class="icon-user"></i>
						<?php echo $LC_LANG['stampManagement'];?>
					</h3>
				</div>
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" value="<?php echo $dataStamp['stamp_name']?>"
									class="form-control" id="stampName"
									placeholder="<?php echo $LC_LANG['stampName'];?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text"
									value="<?php echo $dataStamp['cnt_required']?>"
									class="form-control" id="cntRequired"
									placeholder="<?php echo $LC_LANG['requiredCount'];?>">
							</div>
							<label class="col-lg-2 control-label"><?php echo $LC_LANG['free'];?></label>
							<div class="col-lg-4">
								<input type="text" value="<?php echo $dataStamp['cnt_free']?>"
									class="form-control" id="cntFree"
									placeholder="<?php echo $LC_LANG['freeCount'];?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text" value="<?php echo $cntStamp?>"
						...
						<div class="form-group">
							...
							<div class="col-lg-4">
								<input type="text"
									value="<?php echo $dataStamp['created_time']?>"
									class="form-control" readonly
									style="background: #FEFEFE; cursor: pointer;">
							</div>
							...
							<div class="col-lg-4">
								<input type="text"
									value="<?php echo $dataStamp['updated_time']?>"
									class="form-control" readonly
									style="background: #FEFEFE; cursor: pointer;">
							</div>
						</div>
						...
						<div class="form-group" style="margin-top: 40px;">
							<div class="col-lg-offset-1 col-lg-10"
								...
								<button class="btn-u btn-u-red" style="width: 120px;"
									onclick="window.location.href='stampList.php'">
									<i class="icon-list"></i>
