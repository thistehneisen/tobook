...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			...
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBookings&amp;action=pjActionCreate&amp;as_pf=<?php echo $as_pf; ?>"><?php __('addBooking'); ?></a></li>
			...
			<li class="ui-state-default ui-corner-top"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBookings&amp;action=pjActionCustomer&amp;as_pf=<?php echo $as_pf; ?>"><?php __('customer'); ?></a></li>
					...
					<div class="float_right w300">
						...
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								...
								<input type="text" name="c_email" id="c_email" class="pj-form-field email w150" />
							</span>
						</p>
						<p>
							...
							<span class="pj-form-field-custom pj-form-field-custom-before">
								...
								<input type="text" name="c_phone" id="c_phone" class="pj-form-field w150" />
							</span>
						</p>
						<p>
						...
						<div id="dialogAddCustomer" title="Asiakkaan tiedot" style="display: none;">
							<div class="pj-form">
								<p>
									<input type="text" name="search_customer" id="searchCustomerInfo" class="pj-form-field w300" placeholder="etsi"/>
									<a class="pj-button buttonSearchCustomerInfo" style="display: inline-block;" href="#">Etsi</a>
								</p>
								<p></p>
