	...
	if ( isset($_GET['date']) && !empty($_GET['date']) ){
		...
		<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
			<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
				<li class="ui-state-default ui-corner-top"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminEmployees&amp;action=pjActionCustomTimes&amp;as_pf=<?php echo $as_pf; ?>"><?php __('create_working_shift'); ?></a></li>
				<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminEmployees&amp;action=pjActionEmployeeCustomTime&amp;as_pf=<?php echo $as_pf; ?>"><?php __('working_times'); ?></a></li>
			</ul>
		</div>
			...
			<table cellspacing="0" cellpadding="0" class="pj-table" style="width: 100%; margin-top: 20px;">
				<thead>
					<tr>
						...
						<th style="text-align: center;"><?php echo $e['name']; ?></th>
						<?php } ?>
					</tr>
				</thead>
				<tbody>
				...
				for ( $i = 1; $i <= $count_days; $i++) {
					...
					<tr class="<?php echo $i%2!=0 ? "pj-table-row-odd" : "pj-table-row-even"?>">
						...
						<td><?php echo date($tpl['option_arr']['o_date_format'], strtotime($day));?></td>
						<?php foreach($tpl['employees_arr'] as $e ) { ?>
						<td style="text-align: center;"><?php echo isset($e[$day]) ? $e[$day]['name'] : '--'; ?></td>
						<?php } ?>
					</tr>
					...
					<tr class="pj-table-row-week">
						...
						<td style="text-align: center;">
							<?php
							if ( isset($tpl['employee_hours'][$e['id']][$i]) ) {
								$min = $tpl['employee_hours'][$e['id']][$i] /60;
								$hours =  floor($min/60);
								$min = $min%60;
