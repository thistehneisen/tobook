	...
	<div class="container">
        ...
        <div class="col-md-9">
        	<div class="floatright" style="margin-bottom:5px;">
        		<button class="btn-u btn-u-blue" onclick="onAddStamp()" style="width: 90px;"><i class="icon-plus"></i> <?php echo $LC_LANG['add'];?></button>
				<button class="btn-u btn-u-red" onclick="onDeleteStamp()" style="width: 90px;"><i class="icon-trash"></i> <?php echo $LC_LANG['delete'];?></button>				
			</div>
			<div class="clearboth"></div>
			<div class="panel panel-orange margin-bottom-40">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="icon-user"></i> <?php echo $LC_LANG['stampList'];?></h3>
				</div>
				<?php
				...
				<table class="table table-striped" id="tblDataList">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $i + 1; ?></td>
							<td><a href="stampForm.php?id=<?php echo $dataStamp[$i]['loyalty_stamp']; ?>"><?php echo $dataStamp[$i]['stamp_name']; ?></a></td>
