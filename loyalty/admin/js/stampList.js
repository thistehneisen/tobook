...
function onDeleteStamp( ){
	var objList = $("table#tblDataList").find("input#chkStampId:checkbox:checked");
	if( objList.length == 0 ){ alert("Please select stamps to delete."); return; }
	var strIds = "";
