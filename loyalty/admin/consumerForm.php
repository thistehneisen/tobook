                	...
                	<div class="form-horizontal">
                        ...
                        <div class="form-group" style="margin-top:40px;">
                            <div class="col-lg-offset-1 col-lg-10" style="text-align:center;">
                                <button class="btn-u btn-u-blue" style="margin-right: 20px;width:120px;" onclick="onConsumerSave()"><i class="icon-edit"></i> <?php echo $LC_LANG['save'];?></button>
                                <button class="btn-u btn-u-red" style="width:120px;" onclick="window.location.href='consumerList.php'"><i class="icon-list"></i> <?php echo $LC_LANG['list'];?></button>
                            </div>
                        </div>                                                                        
					</div>
				</div>				
